      ...
      for (subframe in 2 : length(pupil_cols)) {
        ...
        for (tr in 1 : transition_speed) {
          ...
          p[[1]] = plot.trace.visualization(data = control_trace, 
                                               ...
                                               title_str = paste(unique_diagnoses[[1]], '|', 
                                                                 filecodes[control_indices_shuffled[frame]], '|',
                                                                 title_str), # title_str, 
                                               xlab_str = 'Time [s]', 
                                               ylab_str = 'Pupil size',
                                               ylims = c(-80,20),
          ...
          p[[2]] = plot.trace.visualization(data = pathology_trace, 
                                               ...
                                               y_cols = pupil_cols[subframe-1],
                                               y_col2 = pupil_cols[subframe],
                                               title_str = paste(unique_diagnoses[[2]], '|', 
                                                                 filecodes[pathology_indices_shuffled[frame]], '|',
                                                                 title_str), # title_str, 
                                               xlab_str = 'Time [s]', 
                                               ylab_str = 'Pupil size',
                                               ylims = c(-80,20),
